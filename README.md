...
[Project Reference and Release Notes](https://github.com/FolkerKinzel/Strings/releases/tag/v7.3.0)
...
- Extension methods that act as Polyfills for .NET 5.0, .NET Standard 2.1, .NET Standard 2.0, and .NET Framework 4.5 in order to make it easier to support such older Framework versions in Multi Targeting Projects. [(See the complete list.)](https://github.com/FolkerKinzel/Strings/blob/master/src/FolkerKinzel.Strings/md/Polyfills.md)
