...
public static class Test
{
    ...
    public static void TestMethod()
    {
        ...
        Console.WriteLine(" Needles empty: {0}", s.AsSpan().IndexOfAny(ReadOnlySpan<char>.Empty));
        Console.WriteLine(" String empty: {0}", ReadOnlySpan<char>.Empty.IndexOfAny(arr));
        Console.WriteLine(" Needles + String empty: {0}", ReadOnlySpan<char>.Empty.IndexOfAny(ReadOnlySpan<char>.Empty));
        Console.WriteLine();
        ...
        Console.WriteLine(" Needles empty: {0}", s.AsSpan().LastIndexOfAny(ReadOnlySpan<char>.Empty));
        Console.WriteLine(" String empty: {0}", ReadOnlySpan<char>.Empty.LastIndexOfAny(arr));
        Console.WriteLine(" Needles + String empty: {0}", ReadOnlySpan<char>.Empty.LastIndexOfAny(ReadOnlySpan<char>.Empty));
        Console.WriteLine();
    }
