...
public static partial class StringBuilderExtension
{
    ...
    /// of <paramref name="oldValue" /> in the specified substring. If <paramref name="newValue"
    /// /> is <c>null</c> or <see cref="string.Empty" />, all occurrences of <paramref name="oldValue"
    /// /> are removed.</remarks>
    ...
    /// </para>
    /// <para>
    /// Increasing the capacity of <paramref name="builder" /> would exceed <see cref="StringBuilder.MaxCapacity"
    /// />.
    /// </para>
    /// </exception>
    ...
    /// <param name="startIndex">The position in <paramref name="builder" /> where the substring
    /// begins.</param>
    /// <returns>A reference to <paramref name="builder" /> with <paramref name="oldChar"
    /// /> replaced by <paramref name="newChar" /> in the range from <paramref name="startIndex"
    /// /> to the end of <paramref name="builder" />.</returns>
    /// <remarks>This method performs an ordinal, case-sensitive comparison to identify occurrences
    /// of <paramref name="oldChar" /> in the current instance. The size of <paramref name="builder"
    /// /> is unchanged after the replacement.</remarks>
