...
### 4.3.0
- [x] Polyfill `StringBuilder.Append(ReadOnlyMemory<Char>)` (NET45 || NETSTANDARD2_0 || NETSTANDARD2_1)
- [x] `StringBuilder Insert(this StringBuilder builder, int index, ReadOnlyMemory<char> value)`
